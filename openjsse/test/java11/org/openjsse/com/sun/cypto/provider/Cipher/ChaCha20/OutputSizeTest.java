...
public class OutputSizeTest {
    ...
    private static void testCC20GetOutSize()
        ...
        boolean result = true;
        KeyGenerator kg = KeyGenerator.getInstance("ChaCha20", "OpenJSSE");
        kg.init(256);

        // ChaCha20 encrypt
        Cipher cc20 = Cipher.getInstance("ChaCha20", "OpenJSSE");
    ...
    private static void testCC20P1305GetOutSize()
        ...
        // ChaCha20 encrypt
        Cipher cc20 = Cipher.getInstance("ChaCha20-Poly1305", "OpenJSSE");
        cc20.init(Cipher.ENCRYPT_MODE, kg.generateKey(),
    ...
    private static void testMultiPartAEADDec() throws GeneralSecurityException {
        ...
        Cipher enc = Cipher.getInstance("ChaCha20-Poly1305", "OpenJSSE");
        ...
        Cipher dec = Cipher.getInstance("ChaCha20-Poly1305", "OpenJSSE");
