...
public class CheckMyTrustedKeystore {
    ...
    void doServerSide() throws Exception {
        ...
        org.openjsse.com.sun.net.ssl.TrustManager [] tms =
            new org.openjsse.com.sun.net.ssl.TrustManager []
    ...
    void doClientSide() throws Exception {
         ...
         */
        org.openjsse.com.sun.net.ssl.SSLContext ctx1 =
            org.openjsse.com.sun.net.ssl.SSLContext.getInstance("TLS");
        org.openjsse.com.sun.net.ssl.KeyManagerFactory kmf1 =
            org.openjsse.com.sun.net.ssl.KeyManagerFactory.getInstance("SunX509");
        kmf1.init(uks, cpasswd);

        org.openjsse.com.sun.net.ssl.TrustManager [] tms1 =
            new org.openjsse.com.sun.net.ssl.TrustManager []
            { new MyComX509TrustManager() };
...
class MyComX509TrustManager implements org.openjsse.com.sun.net.ssl.X509TrustManager {
