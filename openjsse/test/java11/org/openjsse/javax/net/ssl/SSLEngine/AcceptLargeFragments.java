...
public class AcceptLargeFragments {
    public static void main (String[] args) throws Exception {
        ...
        SSLEngine cliEngine = (org.openjsse.javax.net.ssl.SSLEngine)context.createSSLEngine();
        cliEngine.setUseClientMode(true);

        SSLEngine srvEngine = (org.openjsse.javax.net.ssl.SSLEngine)context.createSSLEngine();
