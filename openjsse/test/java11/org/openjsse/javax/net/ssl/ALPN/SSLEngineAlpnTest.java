...
public class SSLEngineAlpnTest {
    ...
    private org.openjsse.javax.net.ssl.SSLEngine clientEngine;     // client Engine
    private ByteBuffer clientOut;       // write side of clientEngine
    private ByteBuffer clientIn;        // read side of clientEngine

    private org.openjsse.javax.net.ssl.SSLEngine serverEngine;     // server Engine
     ...
     */
    private static void checkAPResult(org.openjsse.javax.net.ssl.SSLEngine engine, SSLEngineResult result,
    ...
    private void createSSLEngines(String[] serverAPs, String callbackAP,
         ...
         */
        serverEngine = (org.openjsse.javax.net.ssl.SSLEngine)sslc.createSSLEngine();
        serverEngine.setUseClientMode(false);

        org.openjsse.javax.net.ssl.SSLParameters sslp = (org.openjsse.javax.net.ssl.SSLParameters)serverEngine.getSSLParameters();
         ...
         */
        clientEngine = (org.openjsse.javax.net.ssl.SSLEngine)sslc.createSSLEngine("client", 80);
        clientEngine.setUseClientMode(true);
        sslp = (org.openjsse.javax.net.ssl.SSLParameters)clientEngine.getSSLParameters();
        if (clientAPs != null) {
    ...
    private static void runDelegatedTasks(SSLEngineResult result,
            org.openjsse.javax.net.ssl.SSLEngine engine) throws Exception {
    ...
    private static boolean isEngineClosed(org.openjsse.javax.net.ssl.SSLEngine engine) {
