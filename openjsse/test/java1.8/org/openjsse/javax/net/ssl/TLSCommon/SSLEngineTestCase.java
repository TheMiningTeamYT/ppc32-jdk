...
abstract public class SSLEngineTestCase {
     ...
     * {@link SSLEngineTestCase#doHandshake(org.openjsse.javax.net.ssl.SSLEngine,
     * org.openjsse.javax.net.ssl.SSLEngine, int, SSLEngineTestCase.HandshakeMode, boolean)
    ...
    public static void doHandshake(SSLEngine clientEngine,
        ...
        org.openjsse.javax.net.ssl.SSLParameters params = (org.openjsse.javax.net.ssl.SSLParameters)clientEngine.getSSLParameters();
        params.setMaximumPacketSize(maxPacketSize);
        clientEngine.setSSLParameters(params);
        params = (org.openjsse.javax.net.ssl.SSLParameters)serverEngine.getSSLParameters();
        params.setMaximumPacketSize(maxPacketSize);
                ...
                switch (TESTED_SECURITY_PROTOCOL) {
                    case "DTLSv1.0":
                        if (Double.parseDouble(
                            System.getProperty("java.specification.version")) == 1.8d)
                        break;
                    case "TLSv1":
                    case "TLSv1.1":
    ...
    private static void handshakeProcess(SSLEngine wrapingEngine,
        ...
        //JDK8 No NEED_UNWRAP_AGAIN
        boolean wrapingHSStatusNeedUnwrapAgain = ((org.openjsse.javax.net.ssl.SSLEngine)wrapingEngine).needUnwrapAgain();
        HandshakeStatus unwrapingHSStatus =
                unwrapingEngine.getHandshakeStatus();
        boolean unwrapingHSStatusNeedUnwrapAgain = ((org.openjsse.javax.net.ssl.SSLEngine)unwrapingEngine).needUnwrapAgain();
        SSLEngineResult r;
        ...
        switch (wrapingHSStatus) {
            ...
            case NOT_HANDSHAKING:
                switch (unwrapingHSStatus) {
                    ...
                    case NEED_UNWRAP:
                        //JDK8 No NEED_UNWRAP_AGAIN
                        if (unwrapingHSStatusNeedUnwrapAgain)
                            break;
...
//                        break;
            ...
            case NEED_UNWRAP:
                //JDK8 No NEED_UNWRAP_AGAIN
                if (!wrapingHSStatusNeedUnwrapAgain)
                    break;
//            case NEED_UNWRAP_AGAIN:
                net.flip();
