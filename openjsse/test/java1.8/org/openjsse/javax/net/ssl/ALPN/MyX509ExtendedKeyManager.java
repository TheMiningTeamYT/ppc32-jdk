...
public class MyX509ExtendedKeyManager extends X509ExtendedKeyManager {
    ...
    public String chooseClientAlias(String[] keyType, Principal[] issuers,
            Socket socket) {
        String nap = ((org.openjsse.javax.net.ssl.SSLSocket) socket).getHandshakeApplicationProtocol();
        checkALPN(nap);
    ...
    public String chooseEngineClientAlias(String[] keyType, Principal[] issuers,
            SSLEngine engine) {
        String nap = ((org.openjsse.javax.net.ssl.SSLEngine)engine).getHandshakeApplicationProtocol();
        checkALPN(nap);
