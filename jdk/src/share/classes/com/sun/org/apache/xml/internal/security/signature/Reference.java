...
public class Reference extends SignatureElementProxy {
    ...
    private byte[] getPreCalculatedDigest(XMLSignatureInput input)
            throws ReferenceNotInitializedException {
        LOG.log(java.util.logging.Level.FINE, "Verifying element with pre-calculated digest");
    ...
    public boolean verify()
        ...
        if (!equal) {
            ...
            LOG.log(java.util.logging.Level.WARNING, "Expected Digest: " + XMLUtils.encodeToString(elemDig));
            LOG.log(java.util.logging.Level.WARNING, "Actual Digest: " + XMLUtils.encodeToString(calcDig));
        } else {
