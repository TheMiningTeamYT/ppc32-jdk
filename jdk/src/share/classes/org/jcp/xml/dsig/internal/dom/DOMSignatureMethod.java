...
public abstract class DOMSignatureMethod extends AbstractDOMSignatureMethod {
    ...
    private static final java.util.logging.Logger LOG =
        java.util.logging.Logger.getLogger(DOMSignatureMethod.class.getName());
        ...
        throws InvalidKeyException, SignatureException, XMLSignatureException
    {
        ...
        LOG.log(java.util.logging.Level.FINE, "JCA Algorithm: " +  getJCAAlgorithm() + "");
        LOG.log(java.util.logging.Level.FINE, "Signature Bytes length: " +  sig.length + "");
    ...
    static final class RIPEMD160withECDSA extends DOMSignatureMethod {
        ...
        @Override
        String getJCAAlgorithm() {
            return "RIPEMD160withECDSA"; // Is this real?
        }
        @Override
        Type getAlgorithmType() {
            return Type.ECDSA;
