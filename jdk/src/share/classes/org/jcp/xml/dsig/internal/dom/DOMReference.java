...
public final class DOMReference extends DOMStructure
    ...
    */
    ...
    private static final java.util.logging.Logger LOG =
        java.util.logging.Logger.getLogger(DOMReference.class.getName());
        ...
        throws XMLSignatureException
    {
        ...
        if (LOG.isLoggable(java.util.logging.Level.FINE)) {
            LOG.log(java.util.logging.Level.FINE, "Expected digest: " + XMLUtils.encodeToString(digestValue));
            LOG.log(java.util.logging.Level.FINE, "Actual digest: " + XMLUtils.encodeToString(calcDigestValue));
        }
