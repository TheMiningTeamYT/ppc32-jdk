...
public final class DOMSignedInfo extends DOMStructure implements SignedInfo {
    ...
    private static final java.util.logging.Logger LOG =
        java.util.logging.Logger.getLogger(DOMSignedInfo.class.getName());
    ...
    public void canonicalize(XMLCryptoContext context, ByteArrayOutputStream bos)
        ...
        try (OutputStream os = new UnsyncBufferedOutputStream(bos)) {
            ...
            if (LOG.isLoggable(java.util.logging.Level.FINE)) {
                ...
                LOG.log(java.util.logging.Level.FINE, "Data to be signed/verified:" + XMLUtils.encodeToString(signedInfoBytes));
            }
