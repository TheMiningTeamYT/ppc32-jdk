...
# do not pass options to the host linker
XLINKERO1 = -Xlinker -O1 -export-dynamic
ADLC_LD_FLAGS=
...
$(EXEC) : $(OBJECTS)
	@echo Making adlc
	$(QUIETLY) $(filter-out $(XLINKERO1),$(filter-out $(ARCHFLAG),$(HOST.LINK_NOPROF.CXX))) $(ADLC_LD_FLAGS) -o $(EXEC) $(OBJECTS)
...
REMOVEHOSTCFLAG = -fcheck-new

$(OUTDIR)/%.o: %.cpp
	@echo Compiling $<
	$(QUIETLY) $(REMOVE_TARGET)
	$(QUIETLY) $(filter-out $(REMOVEHOSTCFLAG),$(filter-out $(ARCHFLAG),$(HOST.COMPILE.CXX))) -o $@ $< $(COMPILE_DONE)
