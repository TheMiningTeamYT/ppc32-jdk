...
class TemplateInterpreter: public AbstractInterpreter {
 ...
 public:
  ...
  static bool try_add_bc_for_jvmti(CodeBlob* cb, GrowableArray<JvmtiCodeBlobDesc*>* _global_code_blobs);

  class InterpreterCodeletClosure {
  public:
    virtual void do_cl(address start, address end, const char* name) = 0;
  };
  static void interpreter_codelet_do(InterpreterCodeletClosure* cl);
