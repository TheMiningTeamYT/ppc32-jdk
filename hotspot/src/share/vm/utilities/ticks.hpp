...
class PairRep {
 public:
  ...
  PairRep() : val1((TYPEARG1)0), val2((TYPEARG2)0) {}
...
template <typename TYPEARG1, typename TYPEARG2>
PairRep<TYPEARG1, TYPEARG2> operator-(const PairRep<TYPEARG1, TYPEARG2>& lhs, const PairRep<TYPEARG1, TYPEARG2>& rhs) {
  PairRep<TYPEARG1, TYPEARG2> temp(lhs);
  temp -= rhs;
  return temp;
}
