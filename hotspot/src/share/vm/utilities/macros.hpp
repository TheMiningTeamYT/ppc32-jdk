...
#define MIPS32_SOFT_FLOAT 1
#else
#define MIPS32_SOFT_FLOAT 0
#endif
...
#if defined(PPC32) || defined(PPC64) || defined(OPENJDK_PPC32)
#ifndef PPC
#define PPC
#endif
...
#ifdef OPENJDK_PPC32
#define OPENJDK_PPC32_ONLY(code) code
#define NOT_OPENJDK_PPC32(code)
#else
#define OPENJDK_PPC32_ONLY(code)
#define NOT_OPENJDK_PPC32(code) code
#endif
