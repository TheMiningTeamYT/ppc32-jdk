...
void Parse::do_one_bytecode() {
  ...
  case Bytecodes::_fneg:
    if(Matcher::match_rule_supported(Op_NegF)) {
      a = pop();
      ...
      Node *f1 = pop();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::f2f_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::fneg),
                                  "fneg", NULL, //no memory effects
                                  f1);
      Node* res = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
      push(res);
#endif // __SOFTFP__
  ...
  case Bytecodes::_fsub:
    if (Matcher::match_rule_supported(Op_SubF)) {
      b = pop();
      a = pop();
      ...
      Node *f2 = pop();
      Node *f1 = pop();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::ff2f_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::fsub),
                                  "fsub", NULL, //no memory effects
                                  f1, f2);
      Node* res = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
      push(res);
#endif // __SOFTFP__
  ...
  case Bytecodes::_fadd:
    if (Matcher::match_rule_supported(Op_AddF)) {
      b = pop();
      a = pop();
      ...
      Node *f1 = pop();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::ff2f_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::fadd),
                                  "fadd", NULL, //no memory effects
                                  f1, f2);
      Node* res = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
      push(res);
#endif // __SOFTFP__
  ...
  case Bytecodes::_fmul:
    if (Matcher::match_rule_supported(Op_MulF)) {
      b = pop();
      a = pop();
      ...
      Node *f1 = pop();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::ff2f_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::fmul),
                                  "fmul", NULL, //no memory effects
                                  f1, f2);
      Node* res = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
      push(res);
#endif // __SOFTFP__
  ...
  case Bytecodes::_fdiv:
    if (Matcher::match_rule_supported(Op_DivF)) {
      b = pop();
      a = pop();
      ...
      Node *f1 = pop();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::ff2f_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::fdiv),
                                  "fdiv", NULL, //no memory effects
                                  f1, f2);
      Node* res = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
      push(res);
#endif // __SOFTFP__
  ...
  case Bytecodes::_frem:
    if (Matcher::match_rule_supported(Op_ModF)) {
  ...
  case Bytecodes::_fcmpl:
    if (Matcher::match_rule_supported(Op_CmpF3)) {
      b = pop();
      a = pop();
      ...
      Node *f2 = pop();
      Node *f1 = pop();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::fcmp_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::fcmpl),
                                  "fcmpl", NULL, //no memory effects
                                  f1, f2);
      Node* res = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
      push(res);
#endif // __SOFTFP__
  ...
  case Bytecodes::_fcmpg:
    if (Matcher::match_rule_supported(Op_CmpF3)) {
      ...
      Node *f1 = pop();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::fcmp_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::fcmpg),
                                  "fcmpg", NULL, //no memory effects
                                  f1, f2);
      Node* res = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
      push(res);
#endif // __SOFTFP__
  ...
  case Bytecodes::_f2i:
    if (Matcher::match_rule_supported(Op_ConvF2I)) {
      a = pop();
      push(_gvn.transform(new (C) ConvF2INode(a)));
#ifdef __SOFTFP__
    } else {
      Node *f1 = pop();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::f2i_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::f2i),
                                  "f2i", NULL, //no memory effects
                                  f1);
      Node* res = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
      push(res);
#endif // __SOFTFP__
  ...
  case Bytecodes::_d2i:
    if (Matcher::match_rule_supported(Op_ConvD2I)) {
      a = pop_pair();
      ...
      Node *d1 = pop_pair();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::d2i_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::d2i),
                                  "d2i", NULL, //no memory effects
                                  d1, top());
      Node* res = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
      push(res);
#endif // __SOFTFP__
  ...
  case Bytecodes::_f2d:
    if (Matcher::match_rule_supported(Op_ConvF2D)) {
      a = pop();
      ...
      Node *f1 = pop();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::f2d_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::f2d),
                                  "f2d", NULL, //no memory effects
                                  f1);
      Node* res_d   = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
  ...
  case Bytecodes::_d2f:
    if (Matcher::match_rule_supported(Op_ConvD2F)) {
      a = pop_pair();
      ...
      Node *d1 = pop_pair();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::d2f_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::d2f),
                                  "d2f", NULL, //no memory effects
                                  d1, top());
      Node* res = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
      push(res);
#endif // __SOFTFP__
  ...
  case Bytecodes::_l2d:
    if (Matcher::match_rule_supported(Op_ConvL2D)) {
      a = pop_pair();
      ...
      Node* f2 = pop();
      Node* f1 = pop();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::l2d_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::l2d),
                                  "l2d", NULL, //no memory effects
                                  f1, f2);
      Node* res_d   = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
  ...
  case Bytecodes::_f2l:
    if (Matcher::match_rule_supported(Op_ConvF2L)) {
      a = pop();
      ...
      Node *f1 = pop();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::f2l_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::f2l),
                                  "f2l", NULL, //no memory effects
                                  f1);
      Node* res   = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
  ...
  case Bytecodes::_d2l:
    if (Matcher::match_rule_supported(Op_ConvD2L)) {
      a = pop_pair();
      ...
      Node *d1 = pop_pair();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::d2l_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::d2l),
                                  "d2l", NULL, //no memory effects
                                  d1, top());
      Node* res   = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
  ...
  case Bytecodes::_dsub:
    if (Matcher::match_rule_supported(Op_SubD)) {
      b = pop_pair();
      a = pop_pair();
      ...
      Node *d1 = pop_pair();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::Math_DD_D_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::dsub),
                                  "dsub", NULL, //no memory effects
                                  d1, top(), d2, top());
      Node* res   = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
  ...
  case Bytecodes::_dadd:
    if (Matcher::match_rule_supported(Op_AddD)) {
      b = pop_pair();
      a = pop_pair();
      ...
      Node *d1 = pop_pair();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::Math_DD_D_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::dadd),
                                  "dadd", NULL, //no memory effects
                                  d1, top(), d2, top());
      Node* res   = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
  ...
  case Bytecodes::_dmul:
    if (Matcher::match_rule_supported(Op_MulD)) {
      b = pop_pair();
      a = pop_pair();
      ...
      Node *d1 = pop_pair();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::Math_DD_D_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::dmul),
                                  "dmul", NULL, //no memory effects
                                  d1, top(), d2, top());
      Node* res   = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
  ...
  case Bytecodes::_ddiv:
    if (Matcher::match_rule_supported(Op_DivD)) {
      b = pop_pair();
      a = pop_pair();
      ...
      Node *d1 = pop_pair();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::Math_DD_D_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::ddiv),
                                  "ddiv", NULL, //no memory effects
                                  d1, top(), d2, top());
      Node* res   = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
  ...
  case Bytecodes::_dneg:
    if (Matcher::match_rule_supported(Op_NegD)) {
      a = pop_pair();
      ...
      Node *d1 = pop_pair();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::Math_D_D_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::dneg),
                                  "dneg", NULL, //no memory effects
                                  d1, top());
      Node* res   = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
  ...
  case Bytecodes::_drem:
    if (Matcher::match_rule_supported(Op_ModD)) {
  ...
  case Bytecodes::_dcmpl:
    if (Matcher::match_rule_supported(Op_CmpD3)) {
      b = pop_pair();
      a = pop_pair();
      ...
      Node *d2 = pop_pair();
      Node *d1 = pop_pair();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::dcmp_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::dcmpl),
                                  "dcmpl", NULL, //no memory effects
                                  d1, top(), d2, top());
      Node* res = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
      push(res);
#endif // __SOFTFP__
  ...
  case Bytecodes::_dcmpg:
    if (Matcher::match_rule_supported(Op_CmpD3)) {
      ...
      Node *d1 = pop_pair();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::dcmp_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::dcmpg),
                                  "dcmpg", NULL, //no memory effects
                                  d1, top(), d2, top());
      Node* res = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
      push(res);
#endif // __SOFTFP__
  ...
  case Bytecodes::_lrem:
    if (Matcher::match_rule_supported(Op_ModL)) {
      // Must keep both values on the expression-stack during null-check
      ...
      Node *l2 = pop_pair();
      Node *l1 = pop_pair();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::Math_LL_L_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::lrem),
                                  "lrem", NULL, //no memory effects
                                  l2, top(), l1, top());
      Node* res   = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
  ...
  case Bytecodes::_ldiv:
    if (Matcher::match_rule_supported(Op_DivL)) {
      // Must keep both values on the expression-stack during null-check
      assert(peek(0) == top(), "long word order");
      zero_check_long(peek(1));
      // Compile-time detect of null-exception?
      ...
      Node *l1 = pop_pair();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::Math_LL_L_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::ldiv),
                                  "ldiv", NULL, //no memory effects
                                  l2, top(), l1, top());
      Node* res   = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
  ...
  case Bytecodes::_i2f:
    if (Matcher::match_rule_supported(Op_ConvI2F)) {
      a = pop();
      ...
      Node *i = pop();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::i2f_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::i2f),
                                  "i2f", NULL, //no memory effects
                                  i);
      Node* res = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
      push(res);
#endif // __SOFTFP__
  ...
  case Bytecodes::_i2d:
    if (Matcher::match_rule_supported(Op_ConvI2D)) {
      a = pop();
      ...
      Node *i = pop();
      Node* c = make_runtime_call(RC_LEAF, OptoRuntime::i2d_Type(),
                                  CAST_FROM_FN_PTR(address, SharedRuntime::i2d),
                                  "i2d", NULL, //no memory effects
                                  i);
      Node* res_d   = _gvn.transform(new (C) ProjNode(c, TypeFunc::Parms + 0));
