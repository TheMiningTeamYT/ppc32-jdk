...
#ifdef __SOFTFP__
  static const TypeFunc* Math_LL_L_Type(); // lrem
#endif
...
#ifdef __SOFTFP__
  static const TypeFunc* fcmp_Type();
  static const TypeFunc* dcmp_Type();
  static const TypeFunc* f2f_Type();
  static const TypeFunc* ff2f_Type();
  static const TypeFunc* f2i_Type();
  static const TypeFunc* d2i_Type();
  static const TypeFunc* i2f_Type();
  static const TypeFunc* i2d_Type();
  static const TypeFunc* f2d_Type();
  static const TypeFunc* d2f_Type();
  static const TypeFunc* l2d_Type();
  static const TypeFunc* f2l_Type();
  static const TypeFunc* d2l_Type();
#endif //__SOFTFP__
