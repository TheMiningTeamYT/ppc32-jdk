...
void JavaClasses::compute_hard_coded_offsets() {
  ...
  com_sun_crypto_provider_AESCrypt::_K_offset = com_sun_crypto_provider_AESCrypt::hc_K_offset  * x + header;
  //  com_sun_crypto_provider_FeedbackCipher
  com_sun_crypto_provider_FeedbackCipher::_embeddedCipher_offset = com_sun_crypto_provider_FeedbackCipher::hc_embeddedCipher_offset  * x + header;
  //  com_sun_crypto_provider_CipherBlockChaining
  com_sun_crypto_provider_CipherBlockChaining::_r_offset = com_sun_crypto_provider_CipherBlockChaining::hc_r_offset  * x + header;

  //  sun_security_provider_SHA
  sun_security_provider_SHA::_state_offset = sun_security_provider_SHA::hc_state * x + header;
  //  sun_security_provider_SHA2
  sun_security_provider_SHA2::_state_offset = sun_security_provider_SHA2::hc_state * x + header;
  //  sun_security_provider_SHA5
  sun_security_provider_SHA5::_state_offset = sun_security_provider_SHA5::hc_state * x + header;
}
