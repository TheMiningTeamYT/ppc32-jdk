...
void nmethod::cleanup_inline_caches() {
  ...
  if (!is_in_use()) {
    low_boundary +=  NOT_MIPS(NativeJump)MIPS_ONLY(NativeGeneralJump)::instruction_size;
...
bool nmethod::make_not_entrant_or_zombie(unsigned int state) {
...

  {
    ...
    if (!is_osr_method() && !is_not_entrant()) {
       NOT_MIPS(NativeJump)MIPS_ONLY(NativeGeneralJump)::patch_verified_entry(entry_point(), verified_entry_point(),
...
void nmethod::verify() {
  ...
  NOT_MIPS(NativeJump)MIPS_ONLY(NativeGeneralJump)::check_verified_entry_alignment(entry_point(), verified_entry_point());
