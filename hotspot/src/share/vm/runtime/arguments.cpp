...
#if INCLUDE_ALL_GCS
  #if (defined JAVASE_EMBEDDED || defined ARM || defined AARCH32)
...
#ifndef COMPILER2
  // ProfileInterpreter have no purpose for client only build.
  // But, if enabled accidentally, will leads to crash, as buffer for
  // profiling data is not allocated. Do not allow that.
  FLAG_SET_DEFAULT(ProfileInterpreter, false);
#endif
