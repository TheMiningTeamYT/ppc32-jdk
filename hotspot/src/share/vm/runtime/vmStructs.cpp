...
#define VM_STRUCTS(nonstatic_field, \
 ...
 unchecked_nonstatic_field(GenCollectedHeap,   _gens,                                         sizeof(GenCollectedHeap::_gens)) /* NOTE: no type */ \
  ...
  /***********************************/                                                                                              \
     ...
     static_field(StubRoutines,                _aes_table_te_addr,                            address)                               \
     static_field(StubRoutines,                _aes_table_td_addr,                            address)                               \
     static_field(StubRoutines,                _cipherBlockChaining_encryptAESCrypt,          address)                               \
     static_field(StubRoutines,                _cipherBlockChaining_decryptAESCrypt,          address)                               \
     static_field(StubRoutines,                _counterMode_AESCrypt,                         address)                               \
     static_field(StubRoutines,                _ghash_processBlocks,                          address)                               \
     static_field(StubRoutines,                _updateBytesCRC32,                             address)                               \
  AARCH32_ONLY(static_field(StubRoutines,      _updateBytesAdler32,                           address))                              \
     static_field(StubRoutines,                _crc_table_adr,                                address)                               \
     static_field(StubRoutines,                _sha1_implCompress,                            address)                               \
     static_field(StubRoutines,                _sha1_table_addr,                              address)                               \
     static_field(StubRoutines,                _sha256_implCompress,                          address)                               \
     static_field(StubRoutines,                _sha256_table_addr,                            address)                               \
     static_field(StubRoutines,                _sha512_implCompress,                          address)                               \
     static_field(StubRoutines,                _sha512_table_addr,                            address)                               \
