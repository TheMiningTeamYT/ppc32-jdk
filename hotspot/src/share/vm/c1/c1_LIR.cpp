...
#if defined(SPARC) || (defined(PPC) && !defined(USE_SPE)) || defined(MIPS)
...
#if defined(ARM) || defined (TARGET_ARCH_aarch64) || defined(AARCH32)
...
#elif defined(SPARC) || (defined(PPC) && !defined(USE_SPE))
  } else if (is_single_fpu()) {
