...
class LIRGenerator: public InstructionVisitor, public BlockClosure {
 ...
 private:
  ...
  void do_update_Adler32(Intrinsic* x);
  void do_process_GHASH(Intrinsic* x);
...
#elif defined(PPC64)
  inline static LIR_Opr java_result_register_for(ValueType* type, bool callee = false) {
    result_register_for(type, callee);
  }
#endif
