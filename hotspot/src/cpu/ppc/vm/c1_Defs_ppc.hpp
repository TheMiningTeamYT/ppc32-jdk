...
enum {
  ...
  // Number of cpu registers killed by calls. (At least R3_ARG1 ... R10_ARG8, but using all like C2.)
  pd_nof_caller_save_cpu_regs_frame_map = PPC64_ONLY(27) NOT_PPC64(26),
  // Number of registers that are visible to register allocator.
  pd_nof_cpu_regs_reg_alloc = PPC64_ONLY(27) NOT_PPC64(26),
...
#else
  pd_nof_fpu_regs_frame_map = 0,              // Number of registers used during code emission.
  pd_nof_caller_save_fpu_regs_frame_map = 0,  // Number of fpu registers killed by calls.
  pd_nof_fpu_regs_reg_alloc = 0,              // Number of registers that are visible to register allocator.
  pd_nof_fpu_regs_linearscan = 0,             // Number of registers visible to linear scan.
#endif
