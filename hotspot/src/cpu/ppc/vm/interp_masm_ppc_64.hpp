...
#else
  void pop_l(     Register r = R17_tos, Register r2 = R30_tos2);
#endif
#ifndef USE_SPE
  void pop_f(FloatRegister f = F15_ftos);
  void pop_d(FloatRegister f = F15_ftos );
#else
  void pop_f(     Register r = R17_tos);
  void pop_d(     Register r = R17_tos);
#endif
...
#else
  void push_l(     Register r = R17_tos, Register r2 = R30_tos2);
#endif
#ifndef USE_SPE
  void push_f(FloatRegister f = F15_ftos );
  void push_d(FloatRegister f = F15_ftos);
#else
  void push_f(Register r = R17_tos );
  void push_d(Register r = R17_tos );
#endif
...
#else
  void push_l_pop_d(Register l = R17_tos, Register l2 = R30_tos2, FloatRegister d = F15_ftos);
  void push_d_pop_l(FloatRegister d = F15_ftos, Register l = R17_tos, Register l2 = R30_tos2);
#endif
#endif
...
#else
  void load_local_long(Register Rdst_value, Register Rdst2_value, Register Rdst_address, Register Rindex);
#endif
...
#else
  void load_local_float(Register Rdst_value, Register Rdst_address, Register Rindex);
  void load_local_double(Register Rdst_value, Register Rdst_address, Register Rindex);
#endif
  void store_local_int(Register Rvalue, Register Rindex);
#ifdef PPC64
  void store_local_long(Register Rvalue, Register Rindex);
#else
  void store_local_long(Register Rvalue, Register Rvalue2, Register Rindex);
#endif
...
#else
  void store_local_float(Register Rvalue, Register Rindex);
  void store_local_double(Register Rvalue, Register Rindex);
#endif

  // Call VM for st frames
