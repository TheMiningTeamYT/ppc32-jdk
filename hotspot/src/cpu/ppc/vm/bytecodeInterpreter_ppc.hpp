...
private:
    ...
    union {
      struct {
        intptr_t  _native_lresult1;            // Save result of native calls that might return handle/longs.
        intptr_t  _native_lresult2;            // Save result of native calls that might return handle/longs.
      } w;
      uint64_t  _native_lresult;            // Save result of native calls that might return handle/longs.
    };
#endif
