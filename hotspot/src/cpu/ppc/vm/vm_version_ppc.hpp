...
protected:
  ...
  enum Feature_Flag_Set {
    ...
    dcba_m                = (1 << dcba   ),
    lwsync_m              = (1 << lwsync ),
    incorrect_single_fp_m = (1 << incorrect_single_fp ),
    lqarx_m               = (1 << lqarx  ),
    vcipher_m             = (1 << vcipher),
    vshasig_m             = (1 << vshasig),
    vpmsumb_m             = (1 << vpmsumb),
...
public:
  ...
  static bool has_lwsync()  { return (_features & lwsync_m) != 0; }
  static bool is_incorrect_single_fp() { return (_features & incorrect_single_fp_m) != 0; }
