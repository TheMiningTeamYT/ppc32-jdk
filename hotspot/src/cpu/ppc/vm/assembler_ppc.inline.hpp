...
inline void Assembler::srdi(    Register a, Register s, int sh6)     { Assembler::rldicl(a, s, (64-sh6)&63, sh6); }
inline void Assembler::srdi_(   Register a, Register s, int sh6)     { Assembler::rldicl_(a, s, (64-sh6)&63, sh6); }
inline void Assembler::srwi(    Register a, Register s, int sh5)     { Assembler::rlwinm(a, s, (32-sh5)&31, sh5, 31); }
inline void Assembler::srwi_(   Register a, Register s, int sh5)     { Assembler::rlwinm_(a, s, (32-sh5)&31, sh5, 31); }
...
inline void Assembler::clrrwi(  Register a, Register s, int ui5)     { Assembler::rlwinm(a, s, 0, 0, 31-ui5); }
inline void Assembler::clrrwi_( Register a, Register s, int ui5)     { Assembler::rlwinm_(a, s, 0, 0, 31-ui5); }
inline void Assembler::clrlwi(  Register a, Register s, int ui5)     { Assembler::rlwinm(a, s, 0, ui5, 31); }
inline void Assembler::clrlwi_( Register a, Register s, int ui5)     { Assembler::rlwinm_(a, s, 0, ui5, 31); }
...
inline void Assembler::clrlslwi( Register a, Register s, int clrl5, int shl5) { Assembler::rlwinm( a, s, shl5, clrl5-shl5, 31-shl5); }
inline void Assembler::clrlslwi_(Register a, Register s, int clrl5, int shl5) { Assembler::rlwinm_(a, s, shl5, clrl5-shl5, 31-shl5); }
inline void Assembler::extrdi(  Register a, Register s, int n, int b){ Assembler::rldicl(a, s, b+n, 64-n); }
inline void Assembler::extrwi(  Register a, Register s, int n, int b){ Assembler::rlwinm(a, s, b+n, 32-n, 31); }
...
inline void Assembler::rlwimi_( Register a, Register s, int sh5, int mb5, int me5){ emit_int32(RLWIMI_OPCODE | rta(a) | rs(s) | sh1620(sh5) | mb2125(mb5) | me2630(me5) | rc(1)); }
...
inline void Assembler::stwux(Register s, Register a,  Register b)  { emit_int32(STWUX_OPCODE| rs(s) | rta0mem(a) | rb(b));}
...
inline void Assembler::smt_prio_medium()      { PPC64_ONLY(Assembler::or_unchecked(R2,  R2,  R2)); }
...
#ifdef __SPE__
inline void Assembler::efsneg(  Register d, Register a) { emit_int32( EFSNEG_OPCODE  | rt(d) | ra(a)); }
inline void Assembler::efsabs(  Register d, Register a) { emit_int32( EFSABS_OPCODE  | rt(d) | ra(a)); }
inline void Assembler::efsnabs( Register d, Register a) { emit_int32( EFSNABS_OPCODE | rt(d) | ra(a)); }

inline void Assembler::efsadd(  Register d, Register a, Register b) { emit_int32( EFSADD_OPCODE  | rt(d) | ra(a) | rb(b)); }
inline void Assembler::efssub(  Register d, Register a, Register b) { emit_int32( EFSSUB_OPCODE  | rt(d) | ra(a) | rb(b)); }
inline void Assembler::efsmul(  Register d, Register a, Register b) { emit_int32( EFSMUL_OPCODE  | rt(d) | ra(a) | rb(b)); }
inline void Assembler::efsdiv(  Register d, Register a, Register b) { emit_int32( EFSDIV_OPCODE  | rt(d) | ra(a) | rb(b)); }

inline void Assembler::efscfd(  Register d, Register b) { emit_int32( EFSCFD_OPCODE   | rt(d) | rb(b)); }
inline void Assembler::efsctsi( Register d, Register b) { emit_int32( EFSCTSI_OPCODE  | rt(d) | rb(b)); }
inline void Assembler::efsctsiz(Register d, Register b) { emit_int32( EFSCTSIZ_OPCODE | rt(d) | rb(b)); }
inline void Assembler::efscfui( Register d, Register b) { emit_int32( EFSCFUI_OPCODE  | rt(d) | rb(b)); }
inline void Assembler::efscfsi( Register d, Register b) { emit_int32( EFSCFSI_OPCODE  | rt(d) | rb(b)); }

inline void Assembler::efscmplt(ConditionRegister crx, Register a, Register b) { emit_int32( EFSCMPLT_OPCODE | bf(crx) | ra(a) | rb(b)); };
inline void Assembler::efscmpgt(ConditionRegister crx, Register a, Register b) { emit_int32( EFSCMPGT_OPCODE | bf(crx) | ra(a) | rb(b)); };
inline void Assembler::efscmpeq(ConditionRegister crx, Register a, Register b) { emit_int32( EFSCMPEQ_OPCODE | bf(crx) | ra(a) | rb(b)); };

inline void Assembler::efdneg(  Register d, Register a) { emit_int32( EFDNEG_OPCODE  | rt(d) | ra(a)); }
inline void Assembler::efdabs(  Register d, Register a) { emit_int32( EFDABS_OPCODE  | rt(d) | ra(a)); }
inline void Assembler::efdnabs( Register d, Register a) { emit_int32( EFDNABS_OPCODE | rt(d) | ra(a)); }

inline void Assembler::efdadd(  Register d, Register a, Register b) { emit_int32( EFDADD_OPCODE  | rt(d) | ra(a) | rb(b)); }
inline void Assembler::efdsub(  Register d, Register a, Register b) { emit_int32( EFDSUB_OPCODE  | rt(d) | ra(a) | rb(b)); }
inline void Assembler::efdmul(  Register d, Register a, Register b) { emit_int32( EFDMUL_OPCODE  | rt(d) | ra(a) | rb(b)); }
inline void Assembler::efddiv(  Register d, Register a, Register b) { emit_int32( EFDDIV_OPCODE  | rt(d) | ra(a) | rb(b)); }

inline void Assembler::efdcfs(  Register d, Register b) { emit_int32( EFDCFS_OPCODE   | rt(d) | rb(b)); }

inline void Assembler::efdcmplt(ConditionRegister crx, Register a, Register b) { emit_int32( EFDCMPLT_OPCODE | bf(crx) | ra(a) | rb(b)); };
inline void Assembler::efdcmpgt(ConditionRegister crx, Register a, Register b) { emit_int32( EFDCMPGT_OPCODE | bf(crx) | ra(a) | rb(b)); };
inline void Assembler::efdcmpeq(ConditionRegister crx, Register a, Register b) { emit_int32( EFDCMPEQ_OPCODE | bf(crx) | ra(a) | rb(b)); };

inline void Assembler::evstdd( Register s, int ui8,    Register a) { emit_int32( EVSTDD_OPCODE   | rs(s) | uimm8(ui8, 20, 16) | ra(a)); };
inline void Assembler::evstddx(Register s, Register a, Register b) { emit_int32( EVSTDDX_OPCODE  | rs(s) | ra(a)              | rb(b)); };
inline void Assembler::evldd(  Register d, int ui8,    Register a) { emit_int32( EVLDD_OPCODE    | rt(d) | uimm8(ui8, 20, 16) | ra(a)); };
inline void Assembler::evlddx( Register d, Register a, Register b) { emit_int32( EVLDDX_OPCODE   | rt(d) | ra(a)              | rb(b)); };

inline void Assembler::evmergelo(Register d, Register a, Register b)   {emit_int32( EVMERGELO_OPCODE   | rt(d) | ra(a) | rb(b));};
inline void Assembler::evmergehi(Register d, Register a, Register b)   {emit_int32( EVMERGEHI_OPCODE   | rt(d) | ra(a) | rb(b));};
inline void Assembler::evmergelohi(Register d, Register a, Register b) {emit_int32( EVMERGELOHI_OPCODE | rt(d) | ra(a) | rb(b));};
inline void Assembler::evmergehilo(Register d, Register a, Register b) {emit_int32( EVMERGEHILO_OPCODE | rt(d) | ra(a) | rb(b));};

inline void Assembler::efdcfsi(Register d, Register b) { emit_int32( EFDCFSI_OPCODE | rt(d) | rb(b)); }
inline void Assembler::efdctsiz(Register d, Register b) { emit_int32( EFDCTSIZ_OPCODE | rt(d) | rb(b)); }

inline void Assembler::mtspefscr( Register s)         { emit_int32(MTSPEFSCR_OPCODE  | rs(s)); }
inline void Assembler::mfspefscr( Register d)         { emit_int32(MFSPEFSCR_OPCODE  | rt(d)); }
#endif // __SPE_
