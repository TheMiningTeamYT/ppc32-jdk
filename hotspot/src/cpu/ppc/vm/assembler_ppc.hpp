...
class Argument VALUE_OBJ_CLASS_SPEC {
 ...
 public:
  enum {
    ...
    n_float_register_parameters_c = PPC64_ONLY(13) NOT_PPC64(8),
...
class Assembler : public AbstractAssembler {
 ...
 public:
  ...
  enum opcdxos_masks {
    ...
    LWZ_OPCODE_MASK     = (63u << OPCODE_SHIFT), // D-FORM
  ...
  enum opcdxos {
    ...
    MTSPEFSCR_OPCODE = (MTSPR_OPCODE | 16 << SPR_5_9_SHIFT),
    MFSPEFSCR_OPCODE = (MFSPR_OPCODE | 16 << SPR_5_9_SHIFT),
...
#ifdef __SPE__
    // opcodes only used for floating arithmetic
    EFSADD_OPCODE   = (4u << OPCODE_SHIFT   |  704u),   //    efsadd RT,RA,RB
    EFSDIV_OPCODE   = (4u << OPCODE_SHIFT   |  713u),   //    efsdiv RT,RA,RB
    EFSABS_OPCODE    = (4u << OPCODE_SHIFT  |  708u),   //    efsabs  RT,RA
    EFSNABS_OPCODE   = (4u << OPCODE_SHIFT  |  709u),   //    efsnabs RT,RA
    EFSMUL_OPCODE    = (4u << OPCODE_SHIFT  |  712u),   //    efsmul  RT,RA,RB
    EFSNEG_OPCODE    = (4u << OPCODE_SHIFT  |  710u),   //    efsneg  RT,RA
    EFSSUB_OPCODE    = (4u << OPCODE_SHIFT  |  705u),   //    efssub  RT,RA,RB

    EFSCFD_OPCODE    = (4u << OPCODE_SHIFT  |  719u),   //    efscfd  RT,RB

    EFSCFUI_OPCODE   = (4u << OPCODE_SHIFT  |  720u),   //    efscfui     RT,RB
    EFSCFSI_OPCODE   = (4u << OPCODE_SHIFT  |  721u),   //    efscfsi     RT,RB
    EFSCTSI_OPCODE   = (4u << OPCODE_SHIFT  |  725u),   //    efsctsi     RT,RB
    EFSCTSIZ_OPCODE  = (4u << OPCODE_SHIFT  |  730u),   //    efsctsiz    RT,RB

    EFSCMPLT_OPCODE  = (4u << OPCODE_SHIFT  |  717u),   //    efscmplt BF,RA,RB
    EFSCMPGT_OPCODE  = (4u << OPCODE_SHIFT  |  716u),   //    efscmplt BF,RA,RB
    EFSCMPEQ_OPCODE  = (4u << OPCODE_SHIFT  |  718u),   //    efscmplt BF,RA,RB

    // opcodes only used for double arithmetic
    EFDADD_OPCODE    = (4u << OPCODE_SHIFT  |  736u),   //    efdadd RT,RA,RB
    EFDDIV_OPCODE    = (4u << OPCODE_SHIFT  |  745u),   //    efddiv RT,RA,RB
    EFDABS_OPCODE    = (4u << OPCODE_SHIFT  |  740u),   //    efdabs  RT,RA
    EFDNABS_OPCODE   = (4u << OPCODE_SHIFT  |  741u),   //    efdnabs RT,RA
    EFDMUL_OPCODE    = (4u << OPCODE_SHIFT  |  744u),   //    efdmul  RT,RA,RB
    EFDNEG_OPCODE    = (4u << OPCODE_SHIFT  |  742u),   //    efdneg  RT,RA
    EFDSUB_OPCODE    = (4u << OPCODE_SHIFT  |  737u),   //    efdsub  RT,RA,RB

    EFDCFS_OPCODE    = (4u << OPCODE_SHIFT  |  751u),   //    efdcfs  RT,RB

    EFDCMPLT_OPCODE  = (4u << OPCODE_SHIFT  |  749u),   //    efscmplt BF,RA,RB
    EFDCMPGT_OPCODE  = (4u << OPCODE_SHIFT  |  748u),   //    efscmplt BF,RA,RB
    EFDCMPEQ_OPCODE  = (4u << OPCODE_SHIFT  |  750u),   //    efscmplt BF,RA,RB

    EVSTDD_OPCODE    = (4u << OPCODE_SHIFT   |  801u),   //    evstdd  RS,D,RA
    EVSTDDX_OPCODE   = (4u << OPCODE_SHIFT   |  800u),   //    evstddx RS,RA,RB
    EVLDD_OPCODE     = (4u << OPCODE_SHIFT   |  769u),   //    evldd   RT,D,RA
    EVLDDX_OPCODE    = (4u << OPCODE_SHIFT   |  768u),   //    evlddx  RT,RA,RB

    EVMERGEHI_OPCODE = (4u << OPCODE_SHIFT   |  556u),   //    evmergehi RT,RA,RB
    EVMERGELO_OPCODE = (4u << OPCODE_SHIFT   |  557u),   //    evmergelo RT,RA,RB
    EVMERGEHILO_OPCODE = (4u << OPCODE_SHIFT |  558u),   //    evmergehilo RT,RA,RB
    EVMERGELOHI_OPCODE = (4u << OPCODE_SHIFT |  559u),   //    evmergehilo RT,RA,RB

    EFDCFSI_OPCODE   = (4u << OPCODE_SHIFT   |  753u),   //    efdcfsi RT,RB
    EFDCTSIZ_OPCODE  = (4u << OPCODE_SHIFT   |  762u),   //    efdctsiz RT, RB
#endif // __SPE__
 ...
 public:
  ...
  static bool is_ev_uimm8_5(int x) {
    return ((x & 0x7) == 0) && is_uimm(x >> 3, 5);
  }
 ...
 public:
  ...
  // unsigned immediate, UI*8, UI is nbits long
  static int uimm8(int x, int hi_bit, int lo_bit) {
    int nbits = hi_bit - lo_bit + 1;
    assert((x & 0x7) == 0, "unaligned offset");
    x = x >> 3;
    assert_unsigned_const(x, nbits);
    return opp_u_field((x & ((1 << nbits) - 1)), hi_bit, lo_bit) ;
  }
...
#else
     return LWZ_OPCODE == (x & LWZ_OPCODE_MASK);
#endif
  }
 ...
 public:
  ...
  inline void clrrwi(  Register a, Register s, int ui5);
  inline void clrrwi_( Register a, Register s, int ui5);
  inline void clrlwi(  Register a, Register s, int ui5);
  inline void clrlwi_( Register a, Register s, int ui5);
  ...
  inline void clrlslwi(Register a, Register s, int clrl5, int shl5);
  inline void clrlslwi_(Register a, Register s, int clrl5, int shl5);
  inline void extrdi(  Register a, Register s, int n, int b);
  inline void extrwi(  Register a, Register s, int n, int b);
  ...
  inline void rlwimi_( Register a, Register s, int sh5, int mb5, int me5);
  ...
  inline void stwux(Register s, Register a,  Register b);
...
#ifdef __SPE__
  inline void efsneg(  Register d, Register b);
  inline void efsabs(  Register d, Register b);
  inline void efsnabs( Register d, Register b);

  // PPC 1, section 4.6.5.1 Floating-Point Elementary Arithmetic Instructions
  inline void efsadd(  Register d, Register a, Register b);
  inline void efssub(  Register d, Register a, Register b);
  inline void efsmul(  Register d, Register a, Register c);
  inline void efsdiv(  Register d, Register a, Register b);

  inline void efdneg(  Register d, Register b);
  inline void efdabs(  Register d, Register b);
  inline void efdnabs( Register d, Register b);

  // PPC 1, section 4.6.5.1 Floating-Point Elementary Arithmetic Instructions
  inline void efdadd(  Register d, Register a, Register b);
  inline void efdsub(  Register d, Register a, Register b);
  inline void efdmul(  Register d, Register a, Register c);
  inline void efddiv(  Register d, Register a, Register b);

  inline void efdcfs(  Register d, Register b);
  // PPC 1, section 4.6.6 Floating-Point Rounding and Conversion Instructions
  inline void efscfd(  Register d, Register b);

  inline void efsctsi( Register d, Register b);
  inline void efsctsiz(Register d, Register b);
  inline void efdcfuid(Register d, Register b);
  inline void efdcfsid(Register d, Register b);
  inline void efscfui( Register d, Register b);
  inline void efscfsi( Register d, Register b);

  inline void efscmplt(ConditionRegister crx, Register a, Register b);
  inline void efscmpgt(ConditionRegister crx, Register a, Register b);
  inline void efscmpeq(ConditionRegister crx, Register a, Register b);

  inline void efdcmplt(ConditionRegister crx, Register a, Register b);
  inline void efdcmpgt(ConditionRegister crx, Register a, Register b);
  inline void efdcmpeq(ConditionRegister crx, Register a, Register b);

  inline void evstdd(  Register s, int si16,   Register a);
  inline void evstddx( Register s, Register a, Register b);
  inline void evldd(   Register d, int si16,   Register a);
  inline void evlddx(  Register d, Register a, Register b);

  inline void evmergehi(   Register d, Register a, Register b);
  inline void evmergelo(   Register d, Register a, Register b);
  inline void evmergehilo( Register d, Register a, Register b);
  inline void evmergelohi( Register d, Register a, Register b);

  inline void efdcfsi(Register d, Register b);
  inline void efdctsiz(Register d, Register b);

  inline void fsqrt( Register d, Register b) {Unimplemented();};
  inline void fsqrts(Register d, Register b) {Unimplemented();};

  inline void mtspefscr(Register s);
  inline void mfspefscr(Register d);
#endif // __SPE__
