...
// PPC32 defines R2 as "System-reserved register",
// it should not be changed by application code
#ifdef PPC64
REGISTER_DECLARATION(Register,      R2_TOC,     R2);  // volatile
#endif
REGISTER_DECLARATION(Register,      R3_RET,     R3);  // volatile
#ifndef PPC64
REGISTER_DECLARATION(Register,      R4_RET2,    R4);  // volatile
#endif
...
#ifndef PPC64
#define R4_RET2            AS_REGISTER(Register, R4)
#endif
...
#ifndef PPC64
REGISTER_DECLARATION(Register, R30_tos2,              R30);
#endif // PPC64
#endif // CC_INTERP
...
#define R30_tos2              AS_REGISTER(Register, R30)
#endif
