...
#define CPU_PPC_VM_C1_FRAMEMAP_PPC_HPP
...
#else
  static LIR_Opr R3_float_opr;
  static LIR_Opr R3_double_opr;
  static LIR_Opr R3_R4_double_opr;
#endif
 ...
 public:
...
#else
  static LIR_Opr as_float_opr(Register r) {
    return LIR_OprFact::single_softfp(cpu_reg2rnr(r));
  }
  static LIR_Opr as_double_opr(Register r) {
    return LIR_OprFact::double_softfp(cpu_reg2rnr(r), cpu_reg2rnr(r));
  }
#endif
  ...
  // R16: java thread
  // R29: global TOC
  static bool reg_needs_save(Register r) { return r != R0 && r != R1 NOT_PPC64(&& r != R2) && r != R13 && r != R16 && r != R29; }
